function fetchRss(_url) {
   ...
   */
  url = `http://query.yahooapis.com/v1/public/yql?q=select%20*%20from%20feednormalizer%20where%20url%3D%27${encodeURIComponent(url)}%27%20and%20output%3D%27atom_1.0%27%20&format=json`;
