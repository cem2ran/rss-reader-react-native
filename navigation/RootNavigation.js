...
export default class RootNavigation extends React.Component {
  ...
  _renderTitle(text: string, isSelected: bool) {
    return (
      <Text
        style={[styles.buttonTitleText, isSelected ? styles.buttonTitleTextSelected : {}]}>
        {text}
      </Text>
    );
  }
  ...
  _renderHeader() {
    return (
      <View
        style={{height: 75, paddingBottom: 12, paddingLeft: 12, backgroundColor: Colors.tintColor, justifyContent: 'flex-end'}}>
